...
class autoloader {
  ...
  const entity = ["entity", "user","emprunteur","emprunt", "materiel"];
  const service= ["autoloader","errorMsg"];
  const manager = ["dataBase","manager" ,"emprunteurManager","empruntManager","materielManager"];

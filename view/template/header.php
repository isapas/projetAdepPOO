    ...
    <head>
      ...
      <link rel="stylesheet" href=<?php echo "http://".$_SERVER['SERVER_NAME']."/Lab/projetAdepObjet/public/css/normalize.css"; ?> >
      <link rel="stylesheet" href=<?php echo "http://".$_SERVER['SERVER_NAME']."/Lab/projetAdepObjet/public/css/main.css"; ?> >
    </head>
    ...
    <header class="jumbotron jumbotron-fluid py-0 mb-0">
      <div class="container d-flex justify-content-between">
        ...
        <div id="logoHeader" class="">
          <a href="https://www.adep-roubaix.fr/" target="_blank"><img src=<?php echo "http://".$_SERVER['SERVER_NAME']."/Lab/projetAdepObjet/public/img/adep-logo.png"; ?> class="img-fluid" alt="Logo de l'ADEP"></a>
        </div>
        <!-- Title -->

...
<script src=<?php echo "http://".$_SERVER['SERVER_NAME']."/Lab/projetAdepObjet/public/js/plugins.js"; ?>></script>
<script src=<?php echo "http://".$_SERVER['SERVER_NAME']."/Lab/projetAdepObjet/public/js/main.js"; ?>></script>

...
<script src=<?php echo "http://".$_SERVER['SERVER_NAME']."/Lab/projet_adepV2/public/js/plugins.js"; ?>></script>
<script src=<?php echo "http://".$_SERVER['SERVER_NAME']."/Lab/projet_adepV2/public/js/main.js"; ?>></script>
